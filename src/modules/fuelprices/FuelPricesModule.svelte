<script>
    ...
    const fetchFuelPrices = async () => {
      ...
      try {
        ...
        console.log("Filtered Gastonia Gas Prices:", fuelPrices.gasData);
  
        stations.set(fuelPrices.gasData || []);
      } catch (error) {
      ...
      {:else}
        {#each $stations as station (station.station)}
          <div class="station-info">
            ...
            <div>
              <p class="price-info">${station.price} USD
              {station.station} {station.address}
